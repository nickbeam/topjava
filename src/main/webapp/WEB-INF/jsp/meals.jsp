    ...
    <table border="1" cellpadding="8" cellspacing="0">
        ...
        <c:forEach items="${meals}" var="meal">
            ...
            <tr data-mealExcess="${meal}">
                ...
                <td>${meal.calories}</td>
                <td><a href="meals/${meal.id}/update"><spring:message code="meal.update"/></a></td>
                <td><a href="meals/${meal.id}/delete"><spring:message code="meal.delete"/></a></td>
            </tr>
        </c:forEach>
    </table>
</section>
