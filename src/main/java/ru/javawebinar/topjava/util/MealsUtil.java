...
public class MealsUtil {
    public static final List<User> USERS = Arrays.asList(
            new User(1, "name1", "name1@mail.com", "123",Role.ROLE_ADMIN),
            new User(2, "name2", "name2@mail.com", "123", Role.ROLE_USER),
            new User(3, "name3", "name3@mail.com", "123", Role.ROLE_USER)
    );
